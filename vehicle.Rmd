---
title: "Vehicle Failure Analysis in USA"
output: 
...
```{r}
data <- read.csv("C:/Users/rajra/Documents/DV/VehicleFailure.csv")
```
...
* As seen from the visual analysis, the top 5 states where vehicle failure cases occur the most are : Texas(293), California(200), Florida(168), Georgia(75) and Arizona(61).
* This report was generated on `r format(Sys.Date(), format = "%B %d, %Y")`.
* This project has been created by: (1) Raj Gupta (19BCE0353); (2) Sriyashree Padhy (19BCE2356); under the guidance of Mrs Sivasankari S.
